...
public class testExcelControllerImpl {
...
//            System.out.println(row0.getLastCellNum());
    ...
    public void testPoi() {
        try {
            ReadConfig.read();
            System.out.println(EntityEnManager.tableHeadDictory);
            ;
            FileInputStream fileInputStream = new FileInputStream("E://叙简科技内部通讯录.xlsx");
            Workbook sheets = WorkbookFactory.create(fileInputStream);
...
//        }
    ...
    public static void main(String[] args) {
        ...
        try {
            EntityEnManager.checkArgs.check(args);

            session = EntityEnManager.getSession();
            DeptMapper deptMapper = session.getMapper(DeptMapper.class);
            MemberMapper memberMapper = session.getMapper(MemberMapper.class);
            DeptEntity ued = new DeptEntity(1010, "UED");
